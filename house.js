    ...
    start: {
        ...
        commands: {
            'start': { 
                        ...
                        when you realize it must have fallen to the <span style="color: white; font-weight: bold;">FLOOR</span>. <i>You should pick them up</i>.<br>
                        (Hint: Type 'pick up glasses')`
                     },
