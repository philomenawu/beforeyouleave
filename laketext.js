...
const gameData = {
    start: {
        ...
        commands: {
            'look': { output: `You're at a small lake hidden deep within the mountains. It's been a while since you last came here...it's the kind of place you just have to stumble upon, and 
                      ...
                      You see a large tree <span style="color:  rgb(37, 74, 194); font-weight: bold;">STUMP</span> in the distance and the broken pieces 
                      of a small wooden <span style="color:  rgb(37, 74, 194); font-weight: bold;">BOAT</span>. The chorus of crickets and frogs are awfully loud tonight. You notice a lone <span style="color:  rgb(37, 74, 194); font-weight: bold;">FROG</span> leaping by the 
                      <span style="color:  rgb(37, 74, 194); font-weight: bold;">SHORE</span>. <i>You wonder if you can catch it...</i>`},
            'examine frog': { output: `You need to catch the <span style="color:  rgb(37, 74, 194); font-weight: bold;">FROG</span> first before you can examine it.`},
            'examine boat': { output: `The <span style="color:  rgb(37, 74, 194); font-weight: bold;">BOAT</span> is too far for you to examine.`},
            'examine stump': { output: `The <span style="color:  rgb(37, 74, 194); font-weight: bold;">STUMP</span> is too far for you to examine.`},
            'go to boat': { nextRoom: 'boat', output: `You move to the <span style="color:  rgb(37, 74, 194); font-weight: bold;">BOAT</span>.`,
                action: function () {
                  document.getElementById('topimg').src="lake1.png";
                }
            },
            'go to stump': { nextRoom: 'stump', output: `You move to the <span style="color:  rgb(37, 74, 194); font-weight: bold;">STUMP</span>.`,
                action: function () {
                  document.getElementById('topimg').src="stump.png";
                }
            },
            'go to shore': { nextRoom: 'shore', output: `You move to the <span style="color:  rgb(37, 74, 194); font-weight: bold;">SHORE</span>.`,
                action: function () {
                  document.getElementById('topimg').src="2x/shore.png";
                }
            },
            'go to frog': { output: `The frog is by the <span style="color:  rgb(37, 74, 194); font-weight: bold;">SHORE</span>.`},
    ...
    shore : {
        description: `The shore of the lake is covered in small rocks and twigs. The reflection of the moon shines brightly across the still water. The tall grass gently sways with the
                      warm breeze.`,
        commands: {
            'look': { output: `You can see towering trees across the lake. Rocks and twigs cover the shore. You see a lone <span style="color:  rgb(37, 74, 194); font-weight: bold;">FROG</span> resting on a larger rock nearby.`},
